    ...
    ***************************************************************************** */
    ...
    var UITreeNode = /** @class */ (function () {
        ...
        UITreeNode.prototype.onDropPoint = function (event, position) {
            ...
            if (this.tree.allowDrop(dragNode, this.node, dragNodeScope, exports.DropType.DropPoint) && isValidDropPointIndex) {
        ...
        UITreeNode.prototype.onDropPointDragEnter = function (event, position) {
            if (this.tree.allowDrop(this.tree.dragNode, this.node, this.tree.dragNodeScope, exports.DropType.DropPoint)) {
                if (position < 0)
        ...
        UITreeNode.prototype.onDropNode = function (event) {
            ...
            if (this.tree.droppableNodes && this.node.droppable !== false) {
                var dragNode = this.tree.dragNode;
                if (this.tree.allowDrop(dragNode, this.node, this.tree.dragNodeScope, exports.DropType.Node)) {
        ...
        UITreeNode.prototype.onDropNodeDragEnter = function (event) {
            if (this.tree.droppableNodes && this.node.droppable !== false && this.tree.allowDrop(this.tree.dragNode, this.node, this.tree.dragNodeScope, exports.DropType.Node)) {
    ...
    var Tree = /** @class */ (function () {
        ...
        Tree.prototype.onDrop = function (event) {
            if (this.droppableNodes && (!this.value || this.value.length === 0)) {
                ...
                if (this.allowDrop(dragNode, null, this.dragNodeScope, exports.DropType.Both)) {
        ...
        Tree.prototype.onDragEnter = function (event) {
            if (this.droppableNodes && this.allowDrop(this.dragNode, null, this.dragNodeScope, exports.DropType.Both)) {
                this.dragHover = true;
            }
        };
            ...
            if (dropScope) {
                if (typeof dropScope === 'string') {
                    ...
                    if (typeof dragScope === 'string') {
                        ...
                        try {
                            for (var dropScope_2 = __values(dropScope), dropScope_2_1 = dropScope_2.next(); !dropScope_2_1.done; dropScope_2_1 = dropScope_2.next()) {
                                var s = dropScope_2_1.value;
                                try {
                                    for (var dragScope_2 = (e_8 = void 0, __values(dragScope)), dragScope_2_1 = dragScope_2.next(); !dragScope_2_1.done; dragScope_2_1 = dragScope_2.next()) {
                                        var ds = dragScope_2_1.value;
                                        if (s === ds) {
                                            return true;
                                        }
                                    }
                                    ...
                                    try {
                                        if (dragScope_2_1 && !dragScope_2_1.done && (_b = dragScope_2.return)) _b.call(dragScope_2);
                                    }
                            ...
                            try {
                                if (dropScope_2_1 && !dropScope_2_1.done && (_a = dropScope_2.return)) _a.call(dropScope_2);
                            }
    ...
    })(exports.DropType || (exports.DropType = {}));
